...
VALUES (nextval('korisnik_seq'), 'perica@gmail.com', '000', TRUE, 'vozac', 'Novi Sad', '064/1834927', 'Perica', 'Peric',
        2,
        'perica@gmail.com', TRUE, '45.253893, 19.847793', FALSE);
INSERT INTO korisnik (id, email, lozinka, aktivan, tip_korisnika, grad, broj_tel, ime, prezime, nacin_placanja,
                      podaci_placanja, status, trenutna_lokacija, u_voznji)
VALUES (nextval('korisnik_seq'), 'nikica@gmail.com', '999', TRUE, 'vozac', 'Novi Sad', '064/1834927', 'Nikica', 'Nikic',
        1,
        'nikica@gmail.com', FALSE, '45.235225, 19.810289', FALSE);
INSERT INTO korisnik (id, email, lozinka, aktivan, tip_korisnika, grad, broj_tel, ime, prezime, nacin_placanja,
                      podaci_placanja, status, trenutna_lokacija, u_voznji)
...
VALUES (nextval('voznja_seq'), 10, 20.5, 'Nema napomene', '2022-01-01 12:00:00', 1500.00, false, 0, '44.7866, 20.4489',
        '44.8158, 20.4569');
INSERT INTO voznja (id, vozac_id, broj_kilometara, napomena, datum_vreme, cena, gotova, ocena, polaziste, destinacija)
VALUES (nextval('voznja_seq'), 8, 10.0, 'Putovanje sa kućnim ljubimcem', '2022-02-15 08:30:00', 800.00, false, 0,
        '45.2671, 19.8335', '45.2488, 19.7930');
INSERT INTO voznja (id, vozac_id, broj_kilometara, napomena, datum_vreme, cena, gotova, ocena, polaziste, destinacija)
VALUES (nextval('voznja_seq'), 10, 30.2, 'Dostava hrane', '2022-03-20 18:45:00', 2000.00, false, 0, '44.7623, 19.6927',
        '44.7844, 19.6959');

-- klijenti za voznju
INSERT INTO voznja_klijenti(voznje_id, klijenti_id)
VALUES (1, 3);
INSERT INTO voznja_klijenti(voznje_id, klijenti_id)
VALUES (2, 4);
INSERT INTO voznja_klijenti(voznje_id, klijenti_id)
...
-- vozila
INSERT INTO vozilo (id, registracija, cena, vozac_id)
VALUES (nextval('vozilo_seq'), 'ABC123', 100.00, 8);
INSERT INTO vozilo (id, registracija, cena, vozac_id)
VALUES (nextval('vozilo_seq'), 'DEF456', 200.00, 9);
INSERT INTO vozilo (id, registracija, cena, vozac_id)
VALUES (nextval('vozilo_seq'), 'GHI789', 300.00, 10);
