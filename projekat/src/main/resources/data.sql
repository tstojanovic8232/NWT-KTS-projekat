...
INSERT INTO korisnik (id, email, lozinka, aktivan, tip_korisnika, grad, broj_tel, ime, prezime, nacin_placanja, podaci_placanja, status,trenutna_lokacija)
VALUES (nextval('hibernate_sequence'), 'tea@gmail.com', '222', TRUE, 'vozac', 'Novi Sad', '063/7077915','Tea','S',2,'teateodora000@gmail.com', FALSE,'45.253893, 19.847793');
